...
// and the rest of the vocabulary in the core package doc. An agent should
// read Details. Message is prose, and its wording is not a contract. The
// fix tag is lifted out into Hint rather than repeated in Details.
