...
func TestIntTypesStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "IntTypesStruct", input.ID).
		Set("int", input.Int).
		Set("int8", input.Int8).
...
func TestFloatTypesStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "FloatTypesStruct", input.ID).
...
func TestStringTypesStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "StringTypesStruct", input.ID).
...
func TestBoolTypesStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "BoolTypesStruct", input.ID).
		Set("bool", input.Bool).
...
func TestByteTypesStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "ByteTypesStruct", input.ID).
...
func TestCompositeTypesStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "CompositeTypesStruct", input.ID).
...
func TestNestedStruct(t *testing.T) {
	...
	record := core.NewRecord("test.repo", "Post", input.ID).
