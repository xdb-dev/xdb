...
imports: gci
	@$(call run-go-mod-dir,$(GCI) -w -local github.com/xdb-dev ./ | { grep -v -e 'skip file .*' || true; },".bin/gci")
...
golangci-lint:
	$(call go-get-tool,$(GOLANGCI_LINT),github.com/golangci/golangci-lint/cmd/golangci-lint@1.53.3)
...
BUF = $(BIN_DIR)/buf
buf:
	$(call go-get-tool,$(BUF),github.com/bufbuild/buf/cmd/buf@v1.26.1)
