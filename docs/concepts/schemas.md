...
A schema groups [records](records.md) and defines their fields. It specifies field types and controls how writes handle undeclared attributes.
...
- Create from JSON: `xdb schemas create xdb://ns/schema --json '{"fields":{...}}'`
